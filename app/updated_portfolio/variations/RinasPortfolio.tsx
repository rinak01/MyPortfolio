...
const CAT_STYLE: Record<Category, { dot: string; active: string; text: string }> = {
  ...
  "Design Systems": { dot: "var(--cat-design)", active: "rgba(100,116,139,0.18)", text: "var(--cat-design)" },
  "Visual Design": { dot: "var(--cat-mit)", active: "rgba(109,40,217,0.18)", text: "var(--cat-mit)" },
};
...
export const ALL_PROJECTS: GridItem[] = [
    ...
    { src: "/images/prototypes/stopmotion01.png", alt: "Stop Motion", tag: "Physical · Animation", label: "Stop Motion", desc: "Frame-by-frame physical animation exploring material storytelling", colSpan: 2, aspectClass: "aspect-[16/9]", categories: ["Rapid Prototyping", "Tangible Environments", "Visual Design"], year: "2023", context: "CMU rapid prototyping", tools: ["Dragonframe", "DSLR", "Mixed materials"], notes: "First stop-motion study, focused on the rhythm and patience of frame-by-frame work. Forced a slower making process: every 12 frames bought less than a second of motion." },
    {
    ...
    { src: "/images/ARVR/studyhall 1.png", alt: "Study Hall", tag: "3D Model · Architecture", label: "Study Hall", desc: "Collaborative virtual study hall with adaptive ambient zones", colSpan: 2, aspectClass: "aspect-[16/9]", categories: ["Spatial Computing", "Visual Design"], year: "2024", context: "CMU 3D environments", tools: ["Maya", "Unity", "Substance Painter"], notes: "A multi-user study hall with zones tuned for different work modes: silent reading at one end, collaborative writing at the other. Ambient audio and lighting shifted as users crossed thresholds, without explicit mode switches." },
    {
